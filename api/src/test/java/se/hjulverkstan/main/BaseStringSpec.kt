...
// abstract class BaseStringSpec(body: StringSpec.() -> Unit) : StringSpec(body) {
    ...
    /*inline fun <reified T> post(url: String, body: Any, token: String? = null): ResponseEntity<T> {

    }

    inline fun <reified T> put(url: String, body: Any, token: String? = null): ResponseEntity<T> {

    }

    inline fun <reified T> delete(url: String, token: String? = null): ResponseEntity<T> {
