...
class TicketDtoTest {
    ...
    @Test
    void applyToEntity_WithNonNullEmployee_SetsEmployee() {
        TicketDto dto = new TicketDto();
        Ticket ticket = new Ticket();
        Employee employee = new Employee();
        ReflectionTestUtils.setField(employee, "id", 99L);
        
        dto.applyToEntity(ticket, new ArrayList<>(), new Location(), employee, new Customer());
        
        assertNotNull(ticket.getEmployee());
        assertEquals(99L, ticket.getEmployee().getId());
    }
