...
public class TextController {
    ...
    @GetMapping()
    public ListResponseDto<TextDto> getAllTexts(@RequestParam Language lang) {
        return textService.getAllTextsByLang(lang);
    }

    @GetMapping("/{id}")
    public TextDto getText(@PathVariable Long id, @RequestParam Language lang) {
        return textService.getTextByLangAndId(id, lang);
    }

    @PutMapping("/{id}")
    public TextDto editText(@PathVariable Long id, @Valid @RequestBody TextDto dto, @RequestParam Language lang) {
