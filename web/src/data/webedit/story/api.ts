...
export type GetStoriesParams = { lang: Lang };

export const createGetStories = ({ lang }: GetStoriesParams) => ({
  queryKey: [endpoints.webedit.story, lang],
  queryFn: () =>
    instance
      .get<GetStoriesRes>(endpoints.webedit.story, { params: { lang } })
...
export type GetStoryParams = WithLang<{ id: string }>;
...
export type CreateStoryParams = WithLang<Omit<Story, 'id'>>;
...
export type EditStoryParams = WithLang<Story>;
...
export type DeleteStoryParams = WithLang<{ id: string }>;
