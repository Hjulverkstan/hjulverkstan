...
describe('DeleteTicketDialog Component', () => {
  test('should render ticket ID and entity description', () => {
    ...
    expect(screen.getByText(/you are trying to delete customer with id t-123/i)).toBeInTheDocument();
  });
  ...
  test('should call onCloseTicket when Close button is clicked', async () => {
    ...
    // Act
    render(<DeleteTicketDialog entity="Ticket" onCloseTicket={onCloseTicket} />);
