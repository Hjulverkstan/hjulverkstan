...
describe('DeleteVehicleDialog Component', () => {
  test('should render vehicle ID and recommended action', () => {
    ...
    expect(screen.getByText(/you are trying to delete vehicle with id v-777/i)).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /archive/i })).toBeInTheDocument();
    expect(screen.getByText(/sets the status to archived/i)).toBeInTheDocument();
  });
