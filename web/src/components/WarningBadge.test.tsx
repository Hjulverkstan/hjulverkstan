...
describe('WarningBadge Component', () => {
  test('should render the id correctly', () => {
    ...
    expect(screen.getByTestId('badge-item')).toHaveAttribute('data-variant', 'default');
  });

  test('should render mapped tooltips and icons when warnings are present', () => {
    // Act
    render(<WarningBadge id="54321" warnings={['WARNING_1', 'WARNING_2']} variant="destructive" />);
