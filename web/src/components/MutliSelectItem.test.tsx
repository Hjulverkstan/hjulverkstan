...
describe('MutliSelectItem Component', () => {
  ...
  test('should render label, icon and count', () => {
    ...
    // Lucide icon check
    expect(screen.getByTestId('command-item').querySelector('svg')).toBeInTheDocument();
  });
  ...
  test('should render CheckIcon when checked', () => {
    ...
    expect(screen.getByTestId('command-item').querySelector('.lucide-check')).toBeInTheDocument();
  });
  ...
  test('should render MinusIcon when intermediate', () => {
    ...
    expect(screen.getByTestId('command-item').querySelector('.lucide-minus')).toBeInTheDocument();
  });
