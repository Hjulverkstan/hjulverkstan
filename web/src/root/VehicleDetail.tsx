  ...
  <>
    ...
    >
      ...
      <IconButton
        ...
        variant="default"
        size="default"
        className="bg-green-accent text-background hover:bg-success-accent -mb-5
          mt-4 h-8 rounded-full md:mb-2 md:mt-2 lg:mb-0 lg:mt-2"
      />
    </div>
  </>
);
      ...
      <Section variant="muted" className="sm: py-32">
        ...
        >
          ...
          >
            ...
            >
              <ShopRentalSection shop={shop} preloadedData={preloadedData} />
            </div>
          </div>
