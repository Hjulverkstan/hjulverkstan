INSERT INTO bike (status, size, location_id, colour)VALUES (0, 26, 1, 'Red');
INSERT INTO bike (status, size, location_id, colour) VALUES (1, 24, 2, 'Blue');
...
-- Inserting locations
INSERT INTO Location (address, name, location_type ,comment, created_at, updated_at, created_by, updated_by)
VALUES ('123 Main Street', 'Hjulverkstan', 'SHOP','Sample location 1 comment', NOW(), NOW(), 1, 1),
       ('456 Elm Street', 'Hjulverkstan', 'SHOP','Sample location 2 comment', NOW(), NOW(), 1, 1);

-- Inserting employees
INSERT INTO Employee (name, last_name, phone_number, email, created_at, updated_at, created_by, updated_by, comment)
VALUES ('John', 'Doe', '123456789', 'john.doe@example.com', NOW(), NOW(), 1, 1, 'Sample comment 1'),
